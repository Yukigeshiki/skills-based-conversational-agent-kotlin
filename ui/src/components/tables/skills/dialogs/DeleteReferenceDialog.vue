  ...
  <Dialog v-model:open="open">
    <DialogContent class="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription>
          Are you sure you want to delete this reference? This will also remove its embeddings. This action cannot be undone.
        </DialogDescription>
      </DialogHeader>
...
/** Confirmation dialog for deleting a skill reference. */
